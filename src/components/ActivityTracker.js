...
class ActivityTracker extends React.Component {
    ...
    componentDidMount() {
        ...
        try {
            const activityJSON = localStorage.getItem(this.props.activity+'activities');
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (prevState.activities.length !== this.state.activities.length) {
            ...
            localStorage.setItem(this.props.activity+'activities', activityJSON);
        }
    }
        ...
        return (
            <div>
                ...
                >
                    ...
                    <h3>{this.state.curActivity.gender}</h3>
                    <p>{this.state.curActivity.message}</p>
